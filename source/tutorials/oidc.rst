...
=============================================
Testovací konfigurace CAAIS s OIDC protokolem
=============================================
...
OIDC konfiguraci CAAIS serveru naleznete na adrese
https://rest-openidconnectapi.caais-test-ext.gov.cz/.well-known/openid-configuration. Další podrobnosti (předávané atributy atd.) jsou uvedeny v dokumentaci pro vývojáře :ref:`api_oidc`.
