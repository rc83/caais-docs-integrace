...
.. list-table:: Využití certifikátů autentizačními protokoly
   :header-rows: 1
...
.. list-table:: Certifikační autority využívané CAAIS pro TLS spojení
   :header-rows: 1
   ...
   * - gov.cz
     ...
     - ≥ 2026
     - Let's Encrypt
     - `E7, E8, R12, R13 <https://letsencrypt.org/certificates/>`_
   * - gov.cz
     - autentizace
     - ≤ 2026
     - DigiCert Inc.
